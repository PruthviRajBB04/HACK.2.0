...
export interface SessionUser { name: string; role: PublicRole; employeeId?: string; organization: string; department: string; assignedMineId?: string; email?: string; isDemo: boolean }
